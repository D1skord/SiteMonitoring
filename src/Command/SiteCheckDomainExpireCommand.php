...
#[AsCommand(name: 'site:check-domain-expire')]
class SiteCheckDomainExpireCommand extends Command
{
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            if ($siteId) {
                ...
                $this->expireDateService->checkDomainExpire($site);
            } else {
                $this->expireDateService->checkDomainsExpire();
            }
